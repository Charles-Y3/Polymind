    ...
    <header className="bg-slate-900/90 border-b border-violet-500/20 backdrop-blur-md sticky top-0 z-40 h-[60px] px-4 text-slate-100">
      <div className="max-w-2xl mx-auto h-full flex items-center justify-between gap-3">
        ...
        <div
          ...
          onClick={onGoHome}
        >
          <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-lg shadow-violet-500/20 ring-1 ring-violet-300/30 group">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Score Badge */}
          <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1 bg-violet-950/40 border border-violet-500/30 rounded-lg text-violet-300 text-xs font-semibold">
